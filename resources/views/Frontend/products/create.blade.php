                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="discount_percentage" class="form-control {{ $errors->has('discount_percentage') ? 'is-invalid' : '' }}" value="{{ old('discount_percentage') }}">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="weight" class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" value="{{ old('weight') }}">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="rate" class="form-control {{ $errors->has('rate') ? 'is-invalid' : '' }}" value="{{ old('rate') }}">
                                @if ($errors->has('rate'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <div class="imagePreview text-center">
                                    <img style="width:70%;height:200px;margin-top:5px" class="image-preview img-thumbnail" src="{{ asset('uploads/products/default.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                <label for=""><b>Save</b></label>
